...
import { getProducts } from '../../../redux/slices/cabletv';
// routes
...
const TABLE_HEAD = [
  ...
  { id: 'decoder', label: 'Decoder Number'},
...
export default function AirtimeLog() {
  ...
  return (
    ...
    <Card>
    <CardHeader title="Cable TV Subscription History" sx={{ mb: 3 }} />
    <Scrollbar>
